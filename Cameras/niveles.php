...
<header class="header d-flex justify-content-between align-items-center">
    ...
    <div class="container mt-5">
        <h1 class="text-primary">Niveles</h1>
        <div class="btn-group mb-4" role="group" aria-label="Niveles">
            <button type="button" class="btn btn-primary" onclick="showLevel(1)">Nivel 1</button>
            <button type="button" class="btn btn-primary" onclick="showLevel(2)">Nivel 2</button>
            <button type="button" class="btn btn-primary" onclick="showLevel(3)">Nivel 3</button>
            <button type="button" class="btn btn-primary" onclick="showLevel(4)">Nivel 4</button>
        </div>
    ...
    <script>
        function showLevel(level) {
            ...
            for (let i = 1; i <= 5; i++) {
                const imgSrc = `camara_nivel${level}_${i}.jpg`;
                const cameraCard = `
                    <div class="col-md-4 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                <h5 class="card-title">Cámara ${i} Nivel ${level}</h5>
                                <img src="${imgSrc}" class="camera-img" alt="Cámara ${i} Nivel ${level}" onclick="showImage('${imgSrc}')">
                            </div>
                        </div>
                    </div>
                `;
        ...
        // Mostrar el Nivel 1 por defecto al cargar la página
        showLevel(1);
    </script>
